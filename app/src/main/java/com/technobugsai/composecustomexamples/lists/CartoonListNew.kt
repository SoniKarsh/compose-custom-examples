...
fun CartoonList() {
    ...
    HorizontalPager(
        ...
        Box(modifier = Modifier
            ...
            AnimatedVisibility(visible = !animationState.isExpanded() && (dimension == 0f),
                ...
                CartoonItem(
                    ...
                    {
                        animationState = ComposeExamplesUtils.AnimationState.Expanded
                    }
                )
            }
        }
...
@Composable
fun CartoonItem(cartoonDataModel: CartoonDataModel, onClick: () -> Unit) {
